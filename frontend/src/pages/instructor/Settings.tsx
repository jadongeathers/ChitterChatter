            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive email notifications about updates and announcements</p>
                </div>
              </div>
              <Switch
        ...
        <Card className="w-full shadow-md border-red-200">
          ...
          <CardContent>
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will deactivate your access to the platform. Your data will be retained for research purposes, but your personal information will be anonymized.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            <p className="text-sm text-gray-500 mt-4">
              Note: Deactivating your account will remove your access to the platform but your data will be retained for research purposes. Your personal information will be anonymized.
            </p>
          </CardContent>
        </Card>
      </motion.div>
